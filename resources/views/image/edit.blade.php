            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg max-w-md mx-auto">
                <div class="max-w-xl">
                    ...
                    <form method="post" action="{{route('image.update')}}" enctype="multipart/form-data" class="mt-6 space-y-6">
                        ...
                        <div>
                        <p class="text-white">Imagen actual</p> <img src="{{route('image.file',['filename' => $image->image_path])}}" alt="" class="edit">
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>{{ __('Actualizar cambios') }}</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
